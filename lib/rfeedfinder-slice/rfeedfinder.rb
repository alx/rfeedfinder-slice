module RfeedfinderSlice
  class Rfeedfinder
    ...
    #   * +:user_agent+: (string) user agent to identify as. Defaults to Ruby/#{RUBY_VERSION} - Rfeedfinder-Slice
    ...
    def self.open_doc(link, options)
      ...
      options[:user_agent] = options[:user_agent] || "Ruby/#{RUBY_VERSION} - Rfeedfinder-Slice"
